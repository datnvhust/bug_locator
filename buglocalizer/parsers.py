...
class BugReport:
    ...
    __slots__ = ['summary', 'description', 'fixed_files',
                 'pos_tagged_summary', 'pos_tagged_description', 'stack_traces', 'bug_id']
    
    def __init__(self, summary, description, fixed_files, bug_id):
...
class SourceFile:
    ...
    __slots__ = ['all_content', 'comments', 'class_names', 'attributes',
                 ...
                 'exact_file_name', 'package_name', 'src_id', 'src_all']
    
    def __init__(self, all_content, comments, class_names, attributes,
                 method_names, variables, file_name, package_name, src_id, src_all):
